...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'sasha@057xq.onmicrosoft.com',
  ...
  protectedRoutes: ['/🌞 Private folder/u-need-a-password','/private','/0day'],
