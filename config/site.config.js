...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'wym@057xq.onmicrosoft.com',
  ...
  protectedRoutes: ['/🌞 Private folder/u-need-a-password', '/tools/IDA','/private','/0day'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:wym@cloudsploit.eu.org',
